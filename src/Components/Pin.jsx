  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={cn(" relative z-50 w-[400px] ", className)}>
            {children}
          </div>
        </div>
      </div>
      <PinPerspective title={title} href={href} techstack={techstack} />
    </div>
  );
};

export const PinPerspective = ({ title, href,techstack }) => {
  return (
      ...
      <div className=" w-[full] h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <Link href={href}>
            ...
            >
              <span className="relative z-20 text-center text-white text-xs font-bold inline-block py-0.5">
                {techstack}
              </span>
